...
# Text Classification / tc-nltk-tfidf-knn.ipynb
# Gourav Siddhad
# 28-Feb-2019
...
plt.legend(loc=4)
plt.title('Accuracy')
plt.savefig('tc-nltk-tfidf-knn.png', dpi=300, pad_inches=0.1)
plt.show()
...
df_knn.to_csv('tc-nltk-tfidf-knn.csv', header=True)
print(' - Done')
...
roc_auc_knn = plot_roc('TFIDF - kNN - Accurate', y_test, y_pred)
