...
# Text Classification / tc-nltk-tfidf-dt.ipynb
# Gourav Siddhad
# 28-Feb-2019
...
print('Training & Testing Random Forest - Done')
...
plt.legend(loc=4)
plt.title('Accuracy')
plt.savefig('tc-nltk-tfidf-dt.png', dpi=300, pad_inches=0.1)
plt.show()
...
df_dt.to_csv('tc-nltk-tfidf-dt.csv', header=True)
print(' - Done')
...
roc_auc_dt = plot_roc('TFIDF - DT - Accurate', y_test, y_pred)
