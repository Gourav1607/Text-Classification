...
# Text Classification / tc-nltk-r-tfidf-rf.ipynb
# Gourav Siddhad
# 04-Mar-2019
...
plt.legend(loc=4)
plt.title('Reduced TFIDF - RF')
plt.savefig('tc-nltk-r-tfidf-rf.png', dpi=150, pad_inches=0.1)
plt.show()
...
df_rf.to_csv('tc-nltk-r-tfidf-rf.csv', header=True)
print(' - Done')
...
roc_auc_rf = plot_roc('tc-nltk-r-tfidf-rf-accurate', y_test, y_pred)
