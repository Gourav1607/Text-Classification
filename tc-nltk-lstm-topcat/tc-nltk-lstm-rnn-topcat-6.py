...
df = pd.DataFrame.from_dict(catcount.items())
...
X_train, X_test, y_train, y_test = train_test_split(
    new_docs, new_labels, test_size=0.2, random_state=42)
print(' - Done')
...
loaded_model.load_weights('model-topcat-6-009-0.917161-0.840018.h5')
